    ...
    def __init__(self, name="u2net"):
        ...
        try:
            if self.torch.cuda.is_available():
                net.load_state_dict(self.torch.load(os.path.join("./image_background_remove_tool/models", name, name + '.pth')))
                net.cuda()
            else:
                net.load_state_dict(self.torch.load(os.path.join("./image_background_remove_tool/models", name, name + '.pth'), map_location="cpu"))
