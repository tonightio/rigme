...
WORKDIR /
RUN pip3 install torch==1.6.0+cu101
RUN pip3 install opencv-python
RUN pip3 install flask
RUN pip3 install open3d==0.9
RUN pip3 install google-colab torchvision scikit-image trimesh torch_geometric gluoncv pycocotools mxnet tensorboard argparse
